  ...
  <header css={styles.header}>
    <Link to="/">
      <div css={styles.title}>
        <LogoWhite height={getDataByViewport({ small: '2rem', medium: '2rem', large: '3rem' })} />
        <span>빠방룸</span>
      </div>
    </Link>
    <div css={styles.link}>
      <HeaderLinkButton
        ...
        content={getDataByViewport({ medium: '홈페이지', large: '빠방 웹 바로가기' })}
      />
      <HeaderLinkButton
        ...
        content={getDataByViewport({ medium: '빠방룸', large: '빠방룸 카카오톡 채널' })}
      />
    </div>
  </header>
);
